...
<script type="text/javascript">
	...
	//匯出範本
	function goExample() {
		var url = "<c:url value = '/'/>crud/apply.referenceOwner.example.action";
	...
	function goQueue() {
		...
		showLoading();
		//alert(document.getElementById("apply_referenceOwner_queue"));
		var formObj = $("form#apply_referenceOwner_queue");
		var formURL = $("form#apply_referenceOwner_queue").attr("action");
		...
		//			if(false)
		{
			...
			var formData = new FormData(document
					.getElementById("apply_referenceOwner_queue"));
			$.ajax({
				url : formURL,
				type : 'POST',
				data : formData,
...
<body>
	<s:form namespace="/crud" action="apply.referenceOwner.queue"
