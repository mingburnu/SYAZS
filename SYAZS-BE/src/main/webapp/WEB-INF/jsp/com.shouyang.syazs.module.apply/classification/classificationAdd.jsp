...
<script type="text/javascript">
	//重設所有欄位(清空)
	function resetData() {
		$("[id^='apply_classification_save_entity']").val("");
	}

	//遞交表單
	function submitData() {
		var data = $('#apply_classification_save').serialize();
		closeDetail();
		goDetail("<c:url value = '/'/>crud/apply.classification.save.action",
				'分類法-新增', data);
	}
</script>
</head>
<body>
	<s:form namespace="/crud" action="apply.classification.save">
