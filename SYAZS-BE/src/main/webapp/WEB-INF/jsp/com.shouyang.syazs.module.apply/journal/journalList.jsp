...
function gotoPage(page){
    ...
    goMain('<c:url value = '/'/>crud/apply.journal.list.action','#apply_journal_list','&pager.currentPage='+page);
}

//變更顯示筆數
function chagePageSize(){
        goMain('<c:url value = '/'/>crud/apply.journal.list.action','#apply_journal_list','&pager.recordPoint='+'${ds.pager.recordPoint }');
}
