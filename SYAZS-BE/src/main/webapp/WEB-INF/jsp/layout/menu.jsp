...
<div id="div-menu">
	...
	<div id="div-menu-contain">
		...
		<div id="menu_items_3" style="display: none;">
			...
			<div class="menu-items">
				<a
					onclick="goURL('<%=request.getContextPath()%>/page/classification.action');">分類法</a>
			</div>
		</div>
		...
		<div id="menu_items_5" style="display: none;">
			...
			<div class="menu-items">
				<a
					onclick="goURL('<%=request.getContextPath()%>/page/feLogs.action?entity.option=clicks');">URL點擊次數統計</a>
			</div>
		</div>
	</div>
</div>