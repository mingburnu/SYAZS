...
<script type="text/javascript">
	...
	//匯出範本
	function goExample() {
		var url = "<c:url value = '/'/>crud/apply.group.example.action";
	...
	function goQueue_detail() {
		...
		var formObj = $("form#apply_group_queue");
		var formURL = $("form#apply_group_queue").attr("action")
		...
		//			if(false)
		{
			...
			var formData = new FormData(document
					.getElementById("apply_group_queue"));
			$.ajax({
				url : formURL,
				type : 'POST',
				data : formData,
...
<body>
	<s:form namespace="/crud" action="apply.group.queue"
