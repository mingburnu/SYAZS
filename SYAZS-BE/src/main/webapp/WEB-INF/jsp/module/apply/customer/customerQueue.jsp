...
function gotoPage_detail(page) {
	...
	if(!isNum){
		...
		goDetail_Main('<c:url value = '/'/>crud/apply.customer.paginate.action',
				'#apply_customer_importData', '&pager.offset='+offset+'&pager.currentPage='+page);
	}
	

//變更顯示筆數
function changePageSize_detail(recordPerPage,recordPoint) {
	goDetail_Main('<c:url value = '/'/>crud/apply.customer.paginate.action','#apply_customer_importData','&recordPerPage='+recordPerPage+'&recordPoint='+recordPoint);
}
	...
	function checkData() {
		...
		goDetail_Main('<c:url value = '/'/>crud/apply.customer.importData.action','#apply_customer_importData','&recordPerPage='+recordPerPage+'&recordPoint='+recordPoint);
